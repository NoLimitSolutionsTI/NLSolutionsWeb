  ...
  return (
    <>
        ...
        <section className={'container-sm services'}>
            <h2 data-aos="fade-up">Algunos de nuestros Servicios</h2>
            <div className={'row mt-5 gx-4 pb-5 flex-md-row flex-sm-column'} data-aos="fade-up" data-aos-delay="100">
                <div className={'media-text col-md-5 align-self-center order-sm-1 order-md-0 mt-4 mt-md-0'} data-aos="fade-up" data-aos-delay="200">
            ...
            <div className={'row gx-4 py-5 flex-md-row flex-sm-column'} data-aos="fade-up" data-aos-delay="100">
                <div className={'media-text order-sm-1 col-md-5 align-self-center mt-4 mt-md-0'} data-aos="fade-up" data-aos-delay="200">
                    <h3>Soporte TI</h3>
        ...
        <section className={'short-us container-md'}>
            <div className={'row'}>
                <div className='col-md-5 order-1 align-self-center mx-auto mt-lg-0 mt-sm-4' data-aos="fade-left" data-aos-delay="100">
        ...
        <section className={'contact-us container-sm py-2'}>
            <h2 className='mb-3' data-aos="fade-up">Impulsa tu negocio con la transformación digital</h2>
